...
export const weddingData = {
  couple: {
    bride: {
      ...
      parentNames: "Anak perempuan dari Bapak Takhrir & Ibu Nunik Rokhati",
      instagram: "@yughilda",
    ...
    groom: {
      ...
      parentNames: "Anak Laki-Laki dari Bapak Agung Budi Prabowo & Ibu Indah Agustiani",
      instagram: "@ghiffaaaa",
  ...
  events: {
    akad: {
      ...
      address: "Jl. Jend Soedirman Purwokerto Utara",
